...
import Styles from '../Styles/SearchIcon.css';

const SearchIcon =()=> {
    return (
        <div className="svgContainer">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" width="20px" fill="rgb(169, 169, 169)" style={{position: "absolute", top: 5, left: 5}}>
